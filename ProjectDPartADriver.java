public class ProjectDPartADriver {
	...
	private static void methodEvaluator() {
		...
		System.out.println("\tFor loops, use a local variable inside the method. Initialize to 0 and then increment for each pass of the loop.");
		System.out.println("\tFor recursion, declare a static variable and initialize to 0. Reset to 0 at the beginning of the recursive method. Increment inside each call to the recursive helper method.");
		System.out.println("\tAt the end of the method, print the total iteration/recursion count.");
