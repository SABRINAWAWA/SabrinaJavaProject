...
public class ProjectDPartBDriver {
	...
	public static void main(String[] args) throws IOException, ParseException {
		...
		System.out.println("\tIf all reports used (line 88 -> false): \t\t4681: ");
		System.out.println("\tIf 40,000 reports used (line 88 -> true, line 89 -> 40000): 4664: " );
		System.out.println("\t\t\t\t\t\t"+ reportTree.countUniqueValues());
*/
		...
		System.out.println("\tIf all reports used (line 88 -> false):\t\t\t\t4681");
		System.out.println("\tIf 40,000 reports used (line 88 -> true, line 89 -> 40000):     4664" );
		System.out.println("\t\t\t\t\t\t\t\tResult: "+ reportTree.countUniqueValues());
*/
	...
	private static List<PoliceReport> readList() throws IOException {
		...
		boolean limitRecordsRead = false;
